        ...
        <div className="border-t border-gray-200">
          <dl>
            ...
            <div className={`bg-white px-4 py-5${loading === false && kurban?.video_path ? "" : "!hidden"}`}>
              ...
              {
                kurban?.video_path && <video width="100%" height="720" controls className={`${loading === false && kurban?.video_path ? "" : "!hidden"}`}><source src={kurban?.video_path ? kurban?.video_path : ""} type="video/mp4" /></video>
              }
