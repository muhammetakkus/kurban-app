function DashboardInfo() {
    ...
    return (
      ...
      <div className="grid gap-6 mb-8 sm:grid-cols-2 xl:grid-cols-4">
              <div
                className="flex items-center p-3 bg-white rounded-lg shadow-xs dark:bg-gray-800"
              >
                <div
              ...
              <div className="flex items-center p-3 bg-white rounded-lg shadow-xs dark:bg-gray-800">
